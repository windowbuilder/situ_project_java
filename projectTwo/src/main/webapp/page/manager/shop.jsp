...
<div style="width: 97%; margin: 20px auto;">
    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="soName" lay-filter="f1" class="soName">
            ...
            <div class="layui-input-inline">
                <select name="sName" id="sName" lay-filter="f2">
    ...
    <div class="layui-input-inline">
        <button class="layui-btn" onclick="down()">一键下架</button>
    </div>
...
<script>
    ...
    function queryByPage(pageNo){
        window.location.href = "queg?pageNo="+pageNo;
    }
